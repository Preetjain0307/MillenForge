...
NeuraMinds converts wireframe sketches, natural language prompts, and existing code into production-ready UI components using AI.
...
```
PORT=5000
MONGODB_URI=mongodb://localhost:27017/neuraminds
...
*NeuraMinds — Foundation v1.0 | SIH Hackathon*
