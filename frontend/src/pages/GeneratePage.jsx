...
const GeneratePage = () => {
  ...
  // Reset prompt error when user types
  useEffect(() => {
    if (promptError && hasPrompt) setPromptError(null);
  }, [generation.prompt]);
            ...
            <div className="nm-card p-5 flex flex-col gap-4">
              ...
              {activeTab === 'prompt' && (
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    <label htmlFor="prompt-input" className="text-xs font-semibold text-[var(--nm-text-primary)]">
                      Describe your UI
                    </label>
